...
export default function EditSignatureFieldPage() {
  ...
  if (!record) {
    return (
      <div className="rounded-lg bg-red-50 border border-red-200 p-4">
        <p className="text-sm text-red-700">Signature Field not found.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">Edit Signature Field</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="signer_id" name="signer_id" type="text" className="input" defaultValue={String(record.signer_id ?? "")} />
        </div>
        ...
        <div>
          ...
          <input id="field_value" name="field_value" type="text" className="input" defaultValue={String(record.field_value ?? "")} />
        </div>

        <div className="flex items-center gap-3 pt-4 border-t">
          <button type="submit" disabled={loading} className="btn-primary">
            {loading ? "Saving..." : "Update Signature Field"}
          </button>
